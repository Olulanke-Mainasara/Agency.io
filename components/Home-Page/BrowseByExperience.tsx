...
const BrowseByExperience = () => {
  return (
    <section className="flex flex-col w-full p-8 py-0 gap-10 xl:py-8">
      ...
      <div className="hidden grid-cols-1 gap-10 xl:grid md:grid-cols-2 xl:grid-cols-4 grow">
      ...
      <div className="grid grid-cols-1 gap-10 xl:hidden md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 grow">
