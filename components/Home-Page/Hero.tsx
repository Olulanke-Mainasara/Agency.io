...
const Hero = () => {
  return (
    <section className="flex flex-col w-screen min-h-screen pt-24 overflow-hidden xl:pt-0">
      <Nav />
      <div className="flex flex-col overflow-hidden grow xl:gap-16 xl:pt-0 xl:flex-row">
        <motion.div
