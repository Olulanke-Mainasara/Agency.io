...
const Nav = () => {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 z-30 h-16 lg:h-20 w-screen text-black bg-white dark:text-white dark:bg-[#111111] flex justify-between items-center px-5 xl:px-6`}
      >
        ...
        <div className="items-center hidden gap-6 lg:flex">
          ...
          {loggedIn ? (
            <Link
              href={"/profile"}
              className="relative w-10 overflow-hidden rounded-full aspect-square"
            >
              <Image
                src={Profile}
                fill
        ...
        {loggedIn ? (
          <Link
            href={"/profile"}
            className="relative w-10 overflow-hidden rounded-full aspect-square lg:hidden"
          >
            <Image
              src={Profile}
              fill
