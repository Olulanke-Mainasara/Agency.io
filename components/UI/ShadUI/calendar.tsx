  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_outside: "text-slate-500 opacity-50 dark:text-white",
      ...
      components={{
        IconLeft: ({ ...props }) => (
          <ChevronLeft className="h-4 w-4 dark:text-white dark:hover:text-white" />
        ),
        IconRight: ({ ...props }) => (
          <ChevronRight className="h-4 w-4 dark:text-white dark:hover:text-white" />
        ),
      }}
      {...props}
    />
